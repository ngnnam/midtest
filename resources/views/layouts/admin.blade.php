                ...
                <div class="section-menu-left">
                    <div class="box-logo">
                        <a href="{{route('admin.index')}}" id="site-logo-inner">
                            <img class="" id="r" alt="" src="{{asset('')}}"
                                data-light="{{asset('')}}" data-dark="{{asset('')}}">
                        </a>
                    ...
                    <div class="header-dashboard">
                        <div class="wrap">
                            <div class="header-left">
                                <a href="index-2.html">
                                    <img class="" id="r_mobile" alt="" src="{{asset('')}}"
                                        data-light="{{asset('')}}" data-dark="{{asset('')}}"
                                        data-width="154px" data-height="52px" data-retina="{{asset('')}}">
                                </a>
                                <div class="button-show-hide">
                                    <i class="icon-menu-left"></i>
                                </div>
                                            ...
                                            <li>
                                                <ul>
                                                    ...
                                                    <li class="product-item gap14 mb-10">
                                                        ...
                                                        <div class="flex items-center justify-between gap20 flex-grow">
                                                            <div class="name">
                                                                <a href="product-list.html" class="body-text">Ngnnam</a>
                                                            </div>
                                                        </div>
                                                    </li>
                                                    <li class="mb-10">
